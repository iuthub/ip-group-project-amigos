...
<div>
	<nav class="nav justify-content-center">
		<a class="nav-link" href="#"><li class="icon-car"><img src="images/icons/instagram.svg"></li></a>
		<a class="nav-link" href="#"><li class="icon-car"><img src="images/icons/twitter.svg"></li></a>
		<a class="nav-link" href="#"><li class="icon-car"><img src="images/icons/facebook.svg"></li></a>
	</nav>
</div>
<nav class="nav justify-content-center">
